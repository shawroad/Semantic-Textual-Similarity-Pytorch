...
def set_args():
    ...
    parser.add_argument('--train_data', default='../data/BQ/BQ.train.data', type=str, help='训练数据集')
    parser.add_argument('--test_data', default='../data/BQ/BQ.test.data', type=str, help='测试数据集')
